...
def parse_arp_header(hex_data):
    ...
    print(f"  {'Operation:':<25} {hex_data[12:16]:<20} | {operations}")
    print(f"  {'Sender MAC:':<25} {hex_data[16:28]:<20} | {senders_mac}")
    print(f"  {'Sender IP:':<25} {hex_data[28:36]:<20} | {senders_ip}")
...
def parse_ipv4_header(hex_data):
    ...
    print(f"  {'Header Length':<25} {hex_data[1:2]:<20} | {internet_header_length}")
    ...
    if protocol == 17:
        ...
        print(f"  {'Unknown Protocol:':<25} {hex_data[18:20]:<20} | {protocol}")
...
def parse_tcp_header(hex_data):
    ...
    print(f"  {'Ack Number':<25} {hex_data[16:24]:<20} | {ack_number}")
    print(f"  {'Data Offset':<25} {hex_data[24:25]:<20} | {data_offset}")
    print(f"  {'Reserved':<25} {hex_data[25:26]:<20} | {reserved}")
